...
// eslint-disable-next-line no-unused-vars
 function Root() {
    ...
    function calculation() { 
        const originalvalue = Math.sqrt(Number1)
    ...
    return (
        <div className="output">
            <h3 className="mainHeading">Calculate the SquaredRoot Value</h3>
           ...
           <p className="outputtext">The SquaredRoot Value is : {value}</p>
        </div>
